public class PersistentStatProvider : IStatProvider
{
    private IStatProvider _statProvider;

    private const int DOP_POWER = 2;

    public PersistentStatProvider(IStatProvider statProvider) => _statProvider = statProvider;
